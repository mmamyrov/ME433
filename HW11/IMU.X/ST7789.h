...
void drawProgressBar(unsigned short x, unsigned short y, 
        unsigned short color, unsigned short background, 
        int progress, int length);
void drawBlock(unsigned short x1, unsigned short y1, 
